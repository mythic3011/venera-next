...
class _AppTabBarState extends State<AppTabBar> {
  ...
  @override
  void dispose() {
    _detachControllerAnimationListener();
  ...
  void didChangeDependencies() {
    ...
    _attachControllerAnimationListener();
  }
  ...
  void _attachControllerAnimationListener() {
    _controllerAnimation = _controller.animation;
    _controllerAnimation?.addListener(onTabChanged);
  }

  void _detachControllerAnimationListener() {
    _controllerAnimation?.removeListener(onTabChanged);
...
class _TabViewBodyState extends State<TabViewBody> {
  ...
  void updateIndex() {
    ...
    if (controller != null && controller.index != _currentIndex) {
      setState(() {
